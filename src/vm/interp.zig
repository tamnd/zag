...
pub const Interp = struct {
    ...
    asyncio_task_class: ?*@import("../object/class.zig").Class = null,
    asyncio_future_class: ?*@import("../object/class.zig").Class = null,
    asyncio_lock_class: ?*@import("../object/class.zig").Class = null,
    asyncio_event_class: ?*@import("../object/class.zig").Class = null,
    asyncio_condition_class: ?*@import("../object/class.zig").Class = null,
    asyncio_semaphore_class: ?*@import("../object/class.zig").Class = null,
    asyncio_bounded_semaphore_class: ?*@import("../object/class.zig").Class = null,
    asyncio_queue_class: ?*@import("../object/class.zig").Class = null,
    asyncio_lifo_queue_class: ?*@import("../object/class.zig").Class = null,
    asyncio_priority_queue_class: ?*@import("../object/class.zig").Class = null,
    asyncio_task_group_class: ?*@import("../object/class.zig").Class = null,
    asyncio_event_loop_class: ?*@import("../object/class.zig").Class = null,
    asyncio_timeout_cm_class: ?*@import("../object/class.zig").Class = null,
    ...
    signal_module: ?*Module = null,
    mmap_module: ?*Module = null,
    mmap_class: ?*@import("../object/class.zig").Class = null,
    mailbox_module: ?*Module = null,
    ...
    functools_partialmethod_class: ?*@import("../object/class.zig").Class = null,
    functools_singledispatch_class: ?*@import("../object/class.zig").Class = null,
    functools_singledispatchmethod_class: ?*@import("../object/class.zig").Class = null,
    ...
    random_class: ?*@import("../object/class.zig").Class = null,
    system_random_class: ?*@import("../object/class.zig").Class = null,
    ...
    threading_bounded_sem_class: ?*@import("../object/class.zig").Class = null,
    threading_live_threads: std.ArrayListUnmanaged(@import("../object/value.zig").Value) = .empty,
    threading_pending_threads: std.ArrayListUnmanaged(@import("../object/value.zig").Value) = .empty,
    threading_current_thread: ?*@import("../object/instance.zig").Instance = null,
    ...
    zlib_error_class: ?*@import("../object/class.zig").Class = null,
    zlib_cobj_class: ?*@import("../object/class.zig").Class = null,
    ...
    subprocess_completed_proc_class: ?*@import("../object/class.zig").Class = null,
    subprocess_error_class: ?*@import("../object/class.zig").Class = null,
    subprocess_called_proc_err_class: ?*@import("../object/class.zig").Class = null,
    subprocess_timeout_class: ?*@import("../object/class.zig").Class = null,
    subprocess_popen_class: ?*@import("../object/class.zig").Class = null,
    ...
    pub fn getBuiltinModule(self: *Interp, name: []const u8) ?*Module {
        ...
        if (std.mem.eql(u8, name, "numbers")) {
        ...
        if (std.mem.eql(u8, name, "signal")) {
            if (self.signal_module) |m| return m;
            const m = @import("signal_mod.zig").build(self) catch return null;
            self.signal_module = m;
            return m;
        }
        if (std.mem.eql(u8, name, "mmap")) {
            if (self.mmap_module) |m| return m;
            const m = @import("mmap_mod.zig").build(self) catch return null;
            self.mmap_module = m;
            return m;
        }
        if (std.mem.eql(u8, name, "mailbox")) {
            if (self.mailbox_module) |m| return m;
            const m = @import("mailbox_mod.zig").build(self) catch return null;
            self.mailbox_module = m;
            return m;
        }
        if (std.mem.eql(u8, name, "mimetypes")) {
